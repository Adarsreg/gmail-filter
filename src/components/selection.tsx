...
const Selection = () => {
  ...
  return (
    <select
      className="bg-purple-600 text-white rounded-lg px-3 py-2 hover:bg-purple-700 transition-colors focus:outline-none focus:ring-2 focus:ring-teal-400 focus:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none transition-transform transform hover:scale-105 "
      value={selectedValue}
